...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_cta_buttons_variant" AS ENUM('default', 'secondary', 'outline');
  CREATE TYPE "public"."enum_pages_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_blocks_cta_buttons_variant" AS ENUM('default', 'secondary', 'outline');
  ...
  CREATE INDEX "header_nav_locale_idx" ON "header_nav" USING btree ("_locale");
